...
function launch_pad_scripts() {
	...
	wp_style_add_data( 'launch-pad-style', 'rtl', 'replace' );

	wp_enqueue_script( 'launch-pad-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
