...
<body <?php body_class(); ?>>
	...
	<div class="container_full_screen">
			...
			<div class="header_inner">
				<div class="header_form">
					<form action="<?php echo home_url(); ?>" class="form_search">
						<input type="text" name="s" id="search__input" value="<?php echo get_search_query(); ?>"
							placeholder="Enter the keywords" required>
				...
				<div class="header_nav">
					<div class="menu">
						...
						if ($header_home) {
							?>
							<a class="menu_item menu_item_home <?php echo $header_home == $page_id ? 'active' : ""; ?>"
								href="<?php echo get_permalink($header_home); ?>">
						...
						if ($header_resources) {
							?>
							<a class="menu_item menu_item_res <?php echo $header_resources == $page_id ? 'active' : ""; ?>"
								href="<?php echo get_permalink($header_resources); ?>">
			...
			<div class="container">
				<div class="header_mb_inner">
					...
					<div class="content_right">
						...
						<div class="bookmark_icon <?php echo $class_page_mark; ?>"
		...
		<div class="sidebar_bottom">
			<div class="container">
				<div class="list">
					...
					if ($header_home) {
						?>
						<a href="<?php echo get_permalink($header_home); ?>"
							class="item <?php echo $header_home == $page_id ? 'active' : ""; ?>">
							<div class="icon">
								<svg width="24" height="25" viewBox="0 0 24 25" fill="none"
									xmlns="http://www.w3.org/2000/svg">
									<path
										d="M11.9998 18.7274V15.7274M10.0698 3.54739L3.13978 9.09739C2.35978 9.71739 1.85978 11.0274 2.02978 12.0074L3.35978 19.9674C3.59978 21.3874 4.95978 22.5374 6.39978 22.5374H17.5998C19.0298 22.5374 20.3998 21.3774 20.6398 19.9674L21.9698 12.0074C22.1298 11.0274 21.6298 9.71739 20.8598 9.09739L13.9298 3.55739C12.8598 2.69739 11.1298 2.69739 10.0698 3.54739Z"
					...
					if ($header_resources) {
						?>
						<a href="<?php echo get_permalink($header_resources); ?>"
							class="item <?php echo $header_resources == $page_id ? 'active' : ""; ?>">
							<div class="icon">
								<svg width="24" height="25" viewBox="0 0 24 25" fill="none"
									xmlns="http://www.w3.org/2000/svg">
									<path
										d="M13.5 12.7273C13.5 15.9073 10.93 18.4773 7.75 18.4773C4.57 18.4773 2 15.9073 2 12.7273C2 9.54729 4.57 6.97729 7.75 6.97729"
										stroke="#2E2E2E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
									<path
										d="M10 12.7273C10 9.41729 12.69 6.72729 16 6.72729C19.31 6.72729 22 9.41729 22 12.7273C22 16.0373 19.31 18.7273 16 18.7273"
										stroke="#2E2E2E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
								</svg>
							</div>
							<div class="title">
					...
					<a href="javascript:void(0);" class="item item_menu">
						<div class="icon">
							<svg width="25" height="25" viewBox="0 0 25 25" fill="none"
								xmlns="http://www.w3.org/2000/svg">
								<path d="M3.5 7.72729H21.5M3.5 12.7273H21.5M3.5 17.7273H21.5" stroke="#2E2E2E"
		...
		<div class="modal fade popup_search" id="popup_search" tabindex="-1" aria-labelledby="exampleModalLabel"
			aria-hidden="true">
				...
				<div class="modal-content">
					<div class="modal-body">
						<div class="box_search">
							<div class="container">
								<form action="<?php echo home_url(); ?>" class="form_search">
									<input type="text" name="s" id="search__input"
										value="<?php echo get_search_query(); ?>" placeholder="Enter the keywords"
										required>
									<button class="styled-link" type="submit"></button>
								</form>
							</div>
		...
		<div class="modal fade popup_menu" id="popup_menu" tabindex="-1" aria-labelledby="exampleModalLabel"
			aria-hidden="true">
