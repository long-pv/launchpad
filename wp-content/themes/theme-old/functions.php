...
function launchpad_setup() {
	...
	register_nav_menus(
		array(
			...
			'footer-1' => esc_html__('Footer 1', 'launchpad'),
			'footer-2' => esc_html__('Footer 2', 'launchpad'),
			'footer-3' => esc_html__('Footer 3', 'launchpad'),
		)
	);
...
function launchpad_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'launchpad' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'launchpad' ),
...
function launchpad_scripts() {
    ...
    // add vendor js
    wp_enqueue_script('launchpad-script-vendor', get_template_directory_uri() . '/assets/js/vendor.js', array(), _S_VERSION, true);

    // Add main css/js
    wp_enqueue_style('launchpad-style-main', get_template_directory_uri() . '/assets/css/main.css', array(), _S_VERSION);
    wp_enqueue_script('launchpad-script-main', get_template_directory_uri() . '/assets/js/main.js', array(), _S_VERSION, true);
}
