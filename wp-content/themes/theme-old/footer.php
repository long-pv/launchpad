 ...
 * @package launchpad
 */
$logo_url = get_template_directory_uri() . '/assets/images/logo-footer.png';

if (get_field('logo_footer', 'option')) {
    $logo_url = get_field('logo_footer', 'option');
}

$bannerFooterPC = get_field('banner_footer_pc','option') ?? '';
$bannerFooterSP = get_field('banner_footer_sp','option') ?? '';
?>
<?php if($bannerFooterPC || $bannerFooterSP) : ?>
<section class="sectionBannerFooter">
    <picture>
        <source media="(min-width: 992px)" srcset="<?php echo $bannerFooterPC ?>">
        <img src="<?php echo $bannerFooterSP ?: $bannerFooterPC ?>" width="100%" alt="Banner footer">
    </picture>
</section>
<?php endif; ?>
...
<?php 
$footer_setting = get_field('footer_setting_en', 'option') ?? null;
?>
                                ...
                                <div class="socialPc">
                                    ...
                                    <div class="footer__social">
                                        ...
                                        if (!empty($footer_setting) && $footer_setting['mail']):
                                            ?>
                                            <a target="_blank" href="mailto:<?php echo $footer_setting['mail']; ?>">
...
<script>
    //let tokenUrl = 'https://login.microsoftonline.com/' + '<?php //echo TENANT_ID; ?>//' + '/oauth2/v2.0/token';
    //let redirectUri = encodeURIComponent('https://launchpad.codluck.online');
